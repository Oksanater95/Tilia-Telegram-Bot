...
############### Arbeit mit Bannern (Informationsseiten)) ###############

async def orm_add_banner_description(session: AsyncSession, data: dict):
    # Neuen Banner hinzufügen oder bestehenden anhand der Menüpunkte ändern:
    # main (Hauptseite), about (Über uns), cart (Warenkorb), shipping (Lieferung), payment (Zahlung), catalog (Katalog)
    query = select(Banner)
...
############ Adminbereich: Produkt hinzufügen/ändern/löschen ########################
