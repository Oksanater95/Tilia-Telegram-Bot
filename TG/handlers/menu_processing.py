...
async def products(session, level, category, page):
    ...
    image = InputMediaPhoto(
        ...
        caption=f"<strong>{product.name}\
                ...
                <strong>Produkt {paginator.page} von {paginator.pages}</strong>",
    )
    ...
    if not carts:
        ...
        image = InputMediaPhoto(
            ...
            caption=f"<strong>{cart.product.name}</strong>\n{cart.product.price}€ x {cart.quantity} = {cart_price}€\
                    \nProdukt {paginator.page} von {paginator.pages} im Warenkorb.\nGesamtpreis der Waren im Warenkorb {total_price}",
        )
